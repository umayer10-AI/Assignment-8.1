...
const CardList = ({p}) => {
    return (
        <div className='rounded-xl border space-y-1.5 hover:scale-105 overflow-hidden transition duration-500 shadow-xl'>
            ...
            <Link href={`all-book/${p.id}`}><Button className={'bg-linear-to-r from-green-500 via-blue-500 bg-green-500 w-full mt-2'}>Details</Button></Link>
            </div>
